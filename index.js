...
const generateWord=(optionValue)=>{
    ...
    optionButtons.forEach((button)=>{
        if(button.innerText.toLowerCase() === optionValue){
            ...
            console.log("you select an option");
        }
        button.disabled=true;
    });
...
//initial function (call when loads /user press new game)
const initializer=()=>{
    winCount=0;
    count=0;
    ...
    for(let i=65;i<91;i++)
    {
        ...
        button.addEventListener("click",()=>{
            ...
            //if array contains clicked value the matched dash with letter else dran on canvas
            if(charArray.includes(button.innerText)){
                ...
                //for drawing man
                drawMan(count);
                //count==6 because head,body,left arm,right arm,left lef,right leg
                if(count==6){
